function Ex_X = gauss_bfgs_crj(a, h, N, z0, d, W, H, L)
% % 
...
Z11=z0;
% Obj(d, t, y, A, b)
Z12= z0+(h*C(1))*(kron(A1(2,1),eye(2*d+1))*Obj(d, tc11, Z11, W, H, L));
% f = Obj(d, t, z, A, b, L)
Z13= z0+h*C(1)*kron(A1(3,1:2),eye(2*d+1))...
    *[Obj(d, tc11, Z11, W, H, L); Obj(d, tc12, Z12, W, H, L)];

Z10= z0+h*C(1)*kron(B1(1:3),eye(2*d+1))...
    *[Obj(d, tc11, Z11, W, H, L); Obj(d, tc12, Z12, W, H, L); Obj(d, tc13, Z13, W, H, L)];
...
F=[Obj(d, t(1), Zk(1:2*d+1), W, H, L);...
     Obj(d, t(2), Zk(2*d+2:4*d+2), W, H, L)];
